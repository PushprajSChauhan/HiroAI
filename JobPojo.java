...
public class JobPojo {
	...
	public JobPojo(int id, String title, String description, String skills, String company, String location,
			...
			int applicantsCount, double score) {
		this.id = id;
		this.title = title;
	...
	public String toString() {
		return "JobPojo [id=" + id + ", title=" + title + ", description=" + description + ", skills=" + skills
				+ ", company=" + company + ", location=" + location + ", experience=" + experience + ", packageLpa="
				+ packageLpa + ", vacancies=" + vacancies + ", employerId=" + employerId + ", createdAt=" + createdAt
				+ ", status=" + status + ", applicantsCount=" + applicantsCount + ", score=" + score + "]";
	}
}
